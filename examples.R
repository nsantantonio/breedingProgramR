...
Ve <- (1 - founderh2) / Vg # error variance
...
# family parameters
	...
	nFam = 10, # number of families (i.e. crosses) made each year
...
userArgsTrad$intAcross <- 0.5 # select the best lines out of the third year trials to make crosses to elite germplasm
