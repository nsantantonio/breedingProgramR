...
#                         for q in 0.4; do
#                             for r in 0 1; do
#                                 tmpSimName="truncVSquadprog${nYr}yr${QTL}_quadprog_fin${k}_fout${l}_N${n}_pull${p}_phRS${q}_sepTrn${r}_truth${j}_rgsc0.2_vdp${nFam[$i]}x${famSize[$i]}"
...
# for i in 1; do 
#     for j in 2 1 0; do
#         tmpSimName="truncVSquadprog${nYr}yr${QTL}_quadprog_fin_fout_N_pull_phRS_sepTrn_truth${j}_rgsc0.2_vdp${nFam[$i]}x${famSize[$i]}"
#         args=("nThreads=${nThreads}" \
#             "nYr=${nYr}" \
#             "simName=$tmpSimName" \
#             "projName=${projName}" \
